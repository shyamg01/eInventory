...
public class US924_DisplayCondimentsPercentageAnd$ extends AbstractTest
{
	
	//TC2333 : Verify that the user is able to view "Condiment" on the Food Over Base landing page in the Current Month section
	
		@Test()
		public void foodOverBase_US924_TC2333() throws InterruptedException,
				RowsExceededException, BiffException, WriteException, IOException {
			/** Variable Section : **/
			AbstractTest.tcName="foodOverBase_US924_TC2333";
