...
public class US1203_Level5Access extends AbstractTest {
	...
	//TC2112 To verify if the level 1 user is able to create daily inventory
	@Test()
	public void sprint12_US1203_TC2112() throws RowsExceededException,
		...
		if (numberofRecordsAfterCreate == numberofRecordsBeforeCreate + 1) {
			...
			Reporter.reportTestFailure(browser,
					"sprint12_US1203_TC2112_Condition1","sprint12_US1203_TC2112",
		...
		if (Base.isElementDisplayed(physicalInventoryPage.DailyInventoryList_Title)) {
			...
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2112_Condition2","sprint12_US1203_TC2112",
	...
	//TC2113 : Verify that the level 5 user should not be able to enter a monthly, weekly and custom list Physical Inventory.
	@Test()
	public void sprint12_US1203_TC2113() throws RowsExceededException,
			BiffException, WriteException, IOException, InterruptedException {
		/** Variable Section : **/
		String userId = LoginTestData.level5_SSO_UserId;
		String password = LoginTestData.level5_SSO_Password;
		...
		if (Boolean.valueOf(physicalInventoryPage.CreateWeeklyInventory_BT.getAttribute("disabled"))
			...
			Reporter.reportTestFailure(
					browser, "sprint12_US1203_TC2113","sprint12_US1203_TC2113",
					"level 5 user should not be able to enter a monthly, weekly Physical Inventory", "Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2113");
		}
	}
	...
	public void sprint12_US1203_TC2116() throws RowsExceededException,
		...
		if (varianceStatPage.verifyVarianceStatLoaded()) {
			Reporter.reportPassResult(
					...
					"level 5 user is able to view daily variance stat", "Pass");
		} else {
			Reporter.reportTestFailure(
					browser, "sprint12_US1203_TC2116","sprint12_US1203_TC2116",
					"level 5 user is able to view daily variance stat", "Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2116_Condition1");
		}
		...
		if (monthlyVarianceDisplayed & Base.isElementDisplayed(varianceStatPage.VarianceStatType_DD)) {
			Reporter.reportPassResult(
					browser,"sprint12_US1203_TC2116",
					"level 5 user is able to view Monthly variance stat",
					"Pass");
		} else {
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2116","sprint12_US1203_TC2116",
					"level 5 user is able to view Monthly variance stat",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2116_Condition2");
		}
	}
	...
	public void sprint12_US1203_TC2117() throws RowsExceededException,
		...
		if (promotionAndWastePage.isRawWasteEntryPresent(Base.returnTodayDate(), wasteAmount)) {
			...
			Reporter.reportTestFailure(
					...
					"Level 5 user should be able to enter Raw Waste.",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2117_Condition1");
		}
		if(Base.isElementDisplayed(promotionAndWastePage.RawPromo_BT) & Base.isElementDisplayed(promotionAndWastePage.CompletedWaste_BT)){
			Reporter.reportTestFailure(
					browser, "sprint12_US1203_TC2117","sprint12_US1203_TC2117",
					"Level 5 user should be restricted to enter Raw Promo and Completed Waste",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2117_Condition2");
		} else {
			Reporter.reportPassResult(browser, "sprint12_US1203_TC2117",
					"Level 5 user should be restricted to enter Raw Promo and Completed Waste.", "Pass");
		}
	}
	...
	public void sprint12_US1203_TC2118() throws RowsExceededException,
		...
		if (Base.isElementDisplayed(homePage.Purchases_BT)&& Base.isElementDisplayed(homePage.CustomRawItemLists_BT)) {
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2118_Condition1","sprint12_US1203_TC2118",
					"Purchage Page and Custome Raw Item list page should not display",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2118_Condition1");
		} else {
			Reporter.reportPassResult(
					browser,"sprint12_US1203_TC2118",
					"Purchage Page and Custome Raw Item list page should not display",
					"Pass");
		}
		...
		if (Base.isElementDisplayed(homePage.PhysicalInventory_BT) && Base.isElementDisplayed(homePage.PromotionAndWaste_BT)) {
			...
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2118_Condition2","sprint12_US1203_TC2118",
					"Physical Inventory Page and Promotion and waste page should  display",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2118_Condition2");
		}
		...
		if (Base.isElementDisplayed(homePage.Transfers_BT) && Base.isElementDisplayed(homePage.ManualVendors_BT)
			...
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2118_Condition3","sprint12_US1203_TC2118",
					"Verify that Transfer,Manual Vendors ,Menu Item Activity ,Menu Item Information ,Food over base pages should not display",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2118_Condition3");
		} else {
			Reporter.reportPassResult(
					browser,"sprint12_US1203_TC2118",
					"Verify that Transfer,Manual Vendors ,Menu Item Activity ,Menu Item Information ,Food over base pages should not display",
		...
		if (Base.isElementDisplayed(homePage.RawItemActivity_BT)&& Base.isElementDisplayed(homePage.RawItemInformation_BT)
			...
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2118_Condition4","sprint12_US1203_TC2118",
					"Verify that Raw Item Activity,Raw Item Information and Daily stat page should display",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2118_Condition4");
		}
	}
	...
	public void sprint12_US1203_TC2121() throws RowsExceededException,
		...
		if (Base.isElementDisplayed(rawItemActivityPage.DoneWithThisItem_BT) 
			...
			Reporter.reportPassResult(
					browser,"sprint12_US1203_TC2121",
					"Raw Item activity page should display in non editable mode",
					"Pass");
		} else {
			Reporter.reportTestFailure(
					browser,"sprint12_US1203_TC2121","sprint12_US1203_TC2121",
					"Raw Item activity page should display in non editable mode",
					"Fail");
			AbstractTest.takeSnapShot("sprint12_US1203_TC2121");
		}
	}
}
